...
// Fetch the completed orders for this worker
$order_sql = "
    ...
    WHERE so.worker_id = ? AND so.order_status = 'finished'
";
...
<body>
    <div class="header_container">
        ...
        <div class="right_part">
            ...
            <a href="wallet.html" class="btn">Balance</a>
    ...
    <div class="main_container">
        <h1 style="text-align: center; padding-top: 30px; padding-bottom: 30px;">Your Completed Orders</h1>

        <?php if ($order_result->num_rows > 0) : ?>
            <?php while ($order = $order_result->fetch_assoc()) : ?>
                <div class="order_card" style="margin-bottom: 30px;">
                    <p>Order from <strong><?php echo htmlspecialchars($order['customer_name']); ?></strong> for <strong><?php echo htmlspecialchars($order['service_name']); ?></strong> service.</p>
                    <p>Earned Amount: <strong><?php echo htmlspecialchars($order['payable_amount']); ?> tk</strong></p>
                    <p><strong>Order Date:</strong> <?php echo htmlspecialchars($order['order_date']); ?></p>
                    <!-- Show Order Status -->
                    <p style="background-color: green; color:aliceblue; width:150px; padding-top:10px;padding-bottom:10px"><strong>Order Status:</strong> <?php echo htmlspecialchars($order['order_status']); ?></p>
                </div>
            <?php endwhile; ?>
        <?php else : ?>
